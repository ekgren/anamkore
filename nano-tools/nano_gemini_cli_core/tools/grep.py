...
def _format_matches(matches_by_file: Dict[str, List[str]], pattern: str) -> str:
    ...
    output = [f"Found {total_matches} {match_term} for pattern \"{pattern}\":\n---"]
...
@function_tool
def search_file_content(pattern: str, path: str = '.', include: Optional[str] = None) -> str:
    """
